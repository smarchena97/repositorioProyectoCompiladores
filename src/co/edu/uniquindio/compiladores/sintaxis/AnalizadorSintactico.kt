...
class AnalizadorSintactico(var listaTokens:ArrayList<Token>) {
    ...
    fun esUnidadDeCompilacion(): UnidadDeCompilacion? {
        ...
        val listaInvocaciones: ArrayList<Invocacion> = esListaInvocaciones()
    ...
    /**
     * <Sentencia> ::= <Desicion> | <DeclaracionVariables> | <DeclaracionMetodos>  | <Asignación> |
...
/*
    ...
    /**
     * Expresion> ::= <ExpresionLogica> | <ExpresionArimetica> | <ExpresionRelacional>
     */
    ...
    /**
     * < ExpresionArimetica > ::= < ExpresionArimetica > operadorAritmetico < ExpresionArimetica> | "("< ExpresionArimetica >")" | <ValorNumerico>
     */
    ...
    fun esDecremento(): Decremento? {
       ...
       */
      fun esListaDatos(): ArrayList<Dato> {
      ...
      /**
       * Dato ::= <ListaEntero>| <ListaDecimal> | <ListaCadena>
       */
      fun esDato(): Dato?{

          if(tokenActual.categoria == Categoria.PALABRA_RESERVADA){

              if(tokenActual.lexema == "numZ"){
                  var listaEntero = esListaEntero()
                  return Dato(listaEntero)
              }
              if(tokenActual.lexema == "numR"){
                  var listaDecimal = esListaDecimal()
                  return Dato(listaDecimal)
              }
              if(tokenActual.lexema == "chordi"){
      ...
      /**
       * <ListaEntero> ::= Entero[<ListaEntero>]
       */
      fun esListaEntero(): ArrayList<Entero> {

          var listaEntero = ArrayList<Entero>()
          var entero = esEntero()
